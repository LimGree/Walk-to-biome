...
public static class UiLocale
{
    ...
    static readonly Dictionary<string, (string ru, string en)> Table =
        new Dictionary<string, (string, string)>(StringComparer.Ordinal)
        {
            ...
            { "settings.daynight", ("Сутки", "Day and night") },
            { "settings.daynight_on", ("Смена дня и ночи", "Day-night cycle") },
            { "settings.day_length", ("Длина суток  {0} мин", "Day length  {0} min") },
            { "settings.world_hour", ("Время  {0}", "Time  {0}") },
            { "settings.clock_visible", ("Часы под миникартой", "Clock under minimap") },
            { "settings.clock_format", ("Формат времени", "Time format") },
            { "settings.clock_h", ("часы", "hours") },
            { "settings.clock_hm", ("часы:минуты", "hours:minutes") },
            { "settings.clock_hms", ("часы:минуты:секунды", "hours:minutes:seconds") },
            { "settings.clock_day", ("Показывать день", "Show day number") },
            { "clock.day", ("День {0}", "Day {0}") },
            { "settings.weather", ("Погода", "Weather") },
            { "settings.weather_auto", ("Смена погоды сама", "Auto weather") },
            { "settings.weather_kind", ("Сейчас", "Now") },
            { "settings.weather_clear", ("ясно", "clear") },
            { "settings.weather_rain", ("дождь", "rain") },
            { "settings.weather_storm", ("гроза", "storm") },
            ...
            { "tut.skip", ("Пропустить", "Skip") },
            { "tut.skip_key", ("{0} — пропустить обучение", "{0} — skip tutorial") },
            { "tut.start", ("Начать", "Start") },
            { "tut.play", ("Играть", "Play") },
            { "tut.welcome.title", ("Walk of Industry", "Walk of Industry") },
            { "tut.welcome.body", ("Ходишь сам, заводы работают даже за горизонтом.\n\nСначала руда, лаборатория и первая глава. Потом плавильня — и дальше сам.", "You walk the world; factories keep running past the horizon.\n\nFirst ore, a lab, and chapter one. Then a smelter — after that you're on your own.") },
            { "tut.bye.title", ("Дальше сам", "You're on your own") },
            { "tut.bye.body", ("Дальше — Mechanical Engineering: 125 Iron Ingot и 125 Cooper Ingot.\n\nДлинная цель — пройти всё дерево исследований, до последнего узла. Копией ускоряй линии, E — рецепты в станках.\n\nПобольше руды, побольше лент. Удачи.", "Next is Mechanical Engineering: 125 Iron Ingot and 125 Cooper Ingot.\n\nThe long goal is the whole research tree. Copy lines to grow faster; E opens recipes.\n\nMore ore, more belts. Good luck.") },
            { "tut.obj.look", ("Осмотрись. WASD — ходьба, мышь — взгляд.", "Look around. WASD to walk, mouse to look.") },
            { "tut.obj.build", ("Нажми {0} — режим строительства.", "Press {0} for build mode.") },
            { "tut.obj.hotbar", ("{0} — инвентарь. Перетащи Extractor, ленту и лабораторию на панель.", "{0} — inventory. Drag Extractor, belt, and lab onto the hotbar.") },
            { "tut.obj.iron", ("Найди железную гору. Экстрактор — только на жилу.", "Find an iron mountain. Place extractors on the vein only.") },
            { "tut.obj.iron3", ("Ещё два экстрактора на это же железо.", "Place two more extractors on the same iron.") },
            { "tut.obj.copy", ("{0} — рамка по трём экстракторам — {1}.", "{0} — box-select the three extractors — {1}.") },
            { "tut.obj.paste", ("Гора Cooper ore. {0} — поставь копию на жилы.", "Find Cooper ore. {0} — paste the copy onto the vein.") },
            { "tut.obj.lab", ("Research Lab между двумя горами.", "Place a Research Lab between the two mountains.") },
            { "tut.obj.research", ("{0} по лаборатории → Basic Automation → Начать. Или {1}.", "{0} on the lab → Basic Automation → Start. Or {1}.") },
            { "tut.obj.belts", ("Довези железо и медь до лаборатории. {0} — линия ленты.", "Belt iron and copper to the lab. {0} draws a line.") },
            { "tut.obj.wait", ("Basic Automation  ·  Iron Ore {0}/{1}  ·  Cooper ore {2}/{3}", "Basic Automation  ·  Iron Ore {0}/{1}  ·  Cooper ore {2}/{3}") },
            { "tut.obj.smelter", ("Поставь Smelter на железную линию.", "Place a Smelter on the iron line.") },
            { "tut.obj.recipe", ("{0} по плавильне → рецепт Iron Ingot.", "{0} on the smelter → Iron Ingot recipe.") },
            { "tut.obj.smelt", ("Пусть в плавильню зайдёт железная руда.", "Feed iron ore into the smelter.") },
            { "tut.obj.copy_smelter", ("Скопируй плавильню на медь: {0}, {1}, {2}. Рецепт Cooper Ingot.", "Copy the smelter onto copper: {0}, {1}, {2}. Cooper Ingot recipe.") },
            { "tut.body.look", ("Горы с рудой рядом. Left Ctrl — бег, Space — прыжок.", "Ore mountains are nearby. Left Ctrl sprints, Space jumps.") },
            { "tut.body.build", ("Снизу выедет панель зданий.", "The building bar slides up from the bottom.") },
            { "tut.body.hotbar", ("Перетащи три карточки на слоты внизу. ПКМ с панели — убрать.", "Drag the three cards onto the slots. RMB removes from the bar.") },
            { "tut.body.iron", ("На горе один тип руды. Железо и медь — на вершинах. Зелёный призрак — клетка подходит. {0} крутит выход.", "One ore per mountain. Iron and copper sit on peaks. Green ghost means the cell is valid. {0} rotates the output.") },
            { "tut.body.iron_map", ("{0} — карта. Ищи гору с железом, иди на пик.", "{0} — map. Find the iron mountain and climb to the peak.") },
            { "tut.body.iron3", ("Один качает медленно. Три — уже нормально. Выходы смотрят в одну сторону, не в скалу. {0} — поворот.", "One is slow. Three is enough. Face the outputs the same way, not into the rock. {0} rotates.") },
            { "tut.body.copy", ("{0} берёт пустой слот (0). Если выбрать здание с панели — режим спадёт. Зажми ПКМ и обведи. Backspace сносит, M с выделением двигает (без выделения M — карта).", "{0} selects the empty tool (0). Picking a building drops edit mode. Hold RMB and drag. Backspace deletes; M moves a selection (without one, M is the map).") },
            { "tut.body.paste", ("{0} крутит группу. Взгляд в сторону — отмена. Копия не ставится на траву: нужна жила.", "{0} rotates the group. Look away to cancel. Copies still need a vein, not grass.") },
            { "tut.body.paste_map", ("{0} — карта. Ищи медь.", "{0} — map. Look for copper.") },
            { "tut.body.lab", ("Лаборатория принимает руду с ленты. На старте одна. Ставь на землю между горами, не на жилу.", "The lab takes ore from belts. You can place one at the start. Put it on ground between the mountains, not on a vein.") },
            { "tut.body.research", ("Сначала запусти исследование. Если руда приедет раньше — лаборатория продаст её за монеты.\nBasic Automation: 125 Iron Ore и 125 Cooper ore.", "Start the research first. Ore that arrives earlier is sold for coins.\nBasic Automation: 125 Iron Ore and 125 Cooper ore.") },
            { "tut.body.research_stuck", ("Посмотри на лабораторию и нажми {0}. Или {1} — то же дерево с ходьбы.", "Look at the lab and press {0}. Or {1} for the same tree while walking.") },
            { "tut.body.belts", ("Зажми ПКМ и веди линию — углы сами. Выход экстрактора → лента → вход лаборатории. Две руды — в T или с двух сторон. {0} — поворот.", "Hold RMB and drag — corners place themselves. Extractor output → belt → lab input. Merge with a T or feed two sides. {0} rotates.") },
            { "tut.body.wait", ("Можно ставить ещё экстракторы — удобно копией. {0} по лаборатории — прогресс в её окне.", "You can place more extractors — copy them. {0} on the lab shows progress.") },
            { "tut.body.smelter", ("Плавильня врезается в ленту: руда входит, слиток выходит. Сборщик в инвентаре, сейчас не нужен.", "The smelter sits in the belt: ore in, ingot out. The assembler is in the inventory; you don't need it yet.") },
            { "tut.body.recipe", ("То же окно, что у лаборатории, только список рецептов. Без рецепта станок стоит.", "Same window as the lab, but it's a recipe list. With no recipe the machine idles.") },
            { "tut.body.smelt", ("Лента во вход плавильни. Когда пойдёт руда — появится слиток.", "Belt into the smelter input. Ore in, ingot out.") },
            { "tut.body.copy_smelter", ("Снова рамка, копия, вставка на медную ленту. Так размножают заводы.", "Box, copy, paste onto the copper belt. That's how factories grow.") },
        };
}
