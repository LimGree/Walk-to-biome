...
public static class UiLocale
{
    ...
    static readonly Dictionary<string, (string ru, string en)> Table =
        new Dictionary<string, (string, string)>(StringComparer.Ordinal)
        {
            ...
            { "tut.obj.research", ("{0} по лаборатории → Печь → Начать. Или {1}.", "{0} on the lab → Smelter → Start. Or {1}.") },
            ...
            { "tut.body.research", ("Сначала запусти исследование. Если руда приедет раньше — лаборатория продаст её за монеты.\nПечь: 140 Iron Ore и 140 Cooper ore.", "Start the research first. Ore that arrives earlier is sold for coins.\nSmelter: 140 Iron Ore and 140 Cooper ore.") },
