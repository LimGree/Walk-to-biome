...
public static class UiLocale
{
    ...
    static readonly Dictionary<string, (string ru, string en)> Table =
        new Dictionary<string, (string, string)>(StringComparer.Ordinal)
        {
            ...
            { "hud.research_done", ("Исследование завершено", "Research complete") },
            ...
            { "research.need", ("Стоимость", "Cost") },
            { "research.prereq", ("Сначала", "Requires") },
            ...
            { "research.auto", ("Идёт само, как только доступно. Несколько узлов сразу.", "Runs on its own as soon as it unlocks. Several nodes at once.") },
            { "research.active_count", ("{0} активных", "{0} active") },
            { "research.none", ("Нет доступных", "None available") },
            ...
            { "machine.tab_research", ("Исследования", "Research") },
            { "machine.tab_recipes", ("Рецепты", "Recipes") },
            { "machine.tab_belts", ("Конвейеры", "Belts") },
            { "machine.tab_stats", ("Статистика", "Stats") },
            { "machine.search_recipe", ("Поиск рецепта", "Search recipes") },
            { "codex.search", ("Поиск предмета или здания", "Search item or building") },
            { "codex.extract", ("Добыча", "Extraction") },
            { "codex.extract_node", ("с жилы / источника", "from a node / source") },
            { "codex.craft", ("Крафт", "Crafting") },
            { "codex.time", ("{0} с", "{0} s") },
            { "codex.locked_research", ("нужно: {0}", "needs: {0}") },
            { "codex.none", ("Нет известного способа получить", "No known way to obtain") },
            { "codex.fluid", ("жидкость", "fluid") },
            { "codex.item", ("предмет", "item") },
            ...
            { "tut.skip_key", ("{0} — всё обучение   ·   {1} — этот шаг", "{0} — skip tutorial   ·   {1} — skip step") },
            ...
            { "tut.obj.research", ("Печь уже идёт. {0} по лаборатории или {1} — посмотреть дерево.", "Smelter is already running. {0} on the lab or {1} to see the tree.") },
            { "tut.obj.belts", ("Довези железо и медь до лаборатории. {0} — линия ленты.", "Belt iron and copper to the lab. {0} draws a line.") },
            { "tut.obj.wait", ("Печь  ·  Iron Ore {0}/{1}  ·  Cooper ore {2}/{3}", "Smelter  ·  Iron Ore {0}/{1}  ·  Cooper ore {2}/{3}") },
            { "tut.obj.smelter", ("Поставь Smelter на железную линию.", "Place a Smelter on the iron line.") },
            { "tut.obj.ingot_iron", ("{0} по лаборатории → Железный слиток. Iron Ore {2}/{3}. Или {1}.", "{0} on the lab → Iron Ingot. Iron Ore {2}/{3}. Or {1}.") },
            { "tut.obj.ingot_copper", ("{0} по лаборатории → Медный слиток. Cooper ore {2}/{3}. Или {1}.", "{0} on the lab → Copper Ingot. Cooper ore {2}/{3}. Or {1}.") },
            ...
            { "tut.body.research", ("Доступные исследования идут сами, сразу несколько. Печь уже активна: 140 Iron Ore и 140 Cooper ore.", "Available research runs on its own, several at once. Smelter is already active: 140 Iron Ore and 140 Cooper ore.") },
            ...
            { "tut.body.smelter", ("Плавильня врезается в ленту: руда входит, слиток выходит. Рецепт ещё закрыт — сначала исследование.", "The smelter sits in the belt: ore in, ingot out. The recipe is still locked — research it next.") },
            { "tut.body.ingot_iron", ("В дереве открой «Железный слиток» и запусти. Нужно 200 Iron Ore в лабораторию. {0} по лаборатории или {1}.", "Open Iron Ingot in the tree and start it. 200 Iron Ore into the lab. {0} on the lab or {1}.") },
            { "tut.body.ingot_copper", ("Теперь «Медный слиток»: 200 Cooper ore в лабораторию. {0} или {1}.", "Now Copper Ingot: 200 Cooper ore into the lab. {0} or {1}.") },
